...
export function buildPreparedBridgeReport(ledger: EvidenceLedger = alexEvidenceLedger) {
  ...
  const report = knowledgeBridgeReportSchema.parse({
    ...
    limitations: [
      "This deterministic report demonstrates the Phase 4 trust and comparison experience for one fictional software scenario. It does not certify mastery or job eligibility.",
