    ...
    findings: [
      {
        ...
        whyItIsUsed: "Teams use explicit API and service conventions to make behavior predictable across consumers, deployments, and maintainers.",
      ...
      },
      {
        ...
        whyItIsUsed: "CI gives every proposed change the same repeatable check and leaves a visible result before the change is merged.",
      ...
      },
      {
        ...
        whyItIsUsed: "Containers make the runtime and installation sequence reproducible across developer machines, test runners, and deployment environments.",
      ...
      },
      {
        ...
        whyItIsUsed: "Operational signals help a team investigate behavior that only appears while the service is running.",
      ...
      },
      {
        ...
        whyItIsUsed: "Cloud platforms provide managed infrastructure and deployment primitives, but their value and tradeoffs depend on the system being operated.",
    ...
    nextSteps: [
      {
        ...
        whyItIsUsed: "A container makes the project's runtime and setup reproducible across developer machines, CI, and deployment environments.",
      ...
      },
      {
        ...
        reuses: "The existing health endpoint test and its pass or fail behavior.",
      ...
      },
      {
        ...
        buildsOn: ["claim-local-test"],
        reuses: "The health endpoint and the idea that runtime behavior can be checked.",
        newConcept: "A request counter or latency measurement with a documented operational question.",
        whyItIsUsed: "A runtime signal helps a team investigate behavior that a binary health check cannot explain.",
